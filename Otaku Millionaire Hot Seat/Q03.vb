Public Class Q03
    ...
    Private Sub Q03_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        questionsRemaining = Q02.questionsRemaining
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level2MoneyTree.Topic03.BackColor = Color.Green
            Level2MoneyTree.Topic03.ForeColor = Color.White
        ...
        Else
            ...
            Level2MoneyTree.Topic03.BackColor = Color.Red
            Level2MoneyTree.Topic03.ForeColor = Color.White
