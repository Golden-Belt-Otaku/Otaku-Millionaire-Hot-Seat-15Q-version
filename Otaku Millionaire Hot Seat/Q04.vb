Public Class Q04
    Friend Q4GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q04_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 3
        GPlayersRemaining = Q03.GPlayersRemaining
        GPlayerNumber = Q03.GPlayerNumber
        questionsRemaining = Q03.questionsRemaining
        SHQuestionsRemaining = Q03.SHQuestionsRemaining
        passUsage = Q03.passUsage
        TopPrizeAmount.Text = Q03.TopPrizeAmount.Text
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q4GamePlay(0)
        Question1.Text = Q4GamePlay(1)
        Question2.Text = Q4GamePlay(2)
        Question3.Text = Q4GamePlay(3)
        ChoiceA.Text = Q4GamePlay(4)
        ChoiceB.Text = Q4GamePlay(5)
        ChoiceC.Text = Q4GamePlay(6)
        ChoiceD.Text = Q4GamePlay(7)
        PlayerScreen.Topic.Text = Q4GamePlay(0)
        PlayerScreen.question(0) = Q4GamePlay(1)
        PlayerScreen.question(1) = Q4GamePlay(2)
        PlayerScreen.question(2) = Q4GamePlay(3)
        PlayerScreen.question(3) = Q4GamePlay(4)
        PlayerScreen.question(4) = Q4GamePlay(5)
        PlayerScreen.question(5) = Q4GamePlay(6)
        PlayerScreen.question(6) = Q4GamePlay(7)
        ...
        CountA = CInt(Q4GamePlay(9))
        CountB = CInt(Q4GamePlay(10))
        CountC = CInt(Q4GamePlay(11))
        CountD = CInt(Q4GamePlay(12))
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level2MoneyTree.Topic04.BackColor = Color.Green
            Level2MoneyTree.Topic04.ForeColor = Color.White
            Level3MoneyTree.Topic04.BackColor = Color.Green
            Level3MoneyTree.Topic04.ForeColor = Color.White
            Level4MoneyTree.Topic04.BackColor = Color.Green
            Level4MoneyTree.Topic04.ForeColor = Color.White
            PlayerScreen.Topic04.BackColor = Color.Green
            PlayerScreen.Topic04.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level2MoneyTree.Topic04.BackColor = Color.Red
            Level2MoneyTree.Topic04.ForeColor = Color.White
            Level3MoneyTree.Topic04.BackColor = Color.Red
            Level3MoneyTree.Topic04.ForeColor = Color.White
            Level4MoneyTree.Topic04.BackColor = Color.Red
            Level4MoneyTree.Topic04.ForeColor = Color.White
            PlayerScreen.Topic04.BackColor = Color.Red
            PlayerScreen.Topic04.ForeColor = Color.White
        End If
    End Sub
