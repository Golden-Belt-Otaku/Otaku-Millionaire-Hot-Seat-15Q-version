...
Public Class Q13
    Friend Q13GamePlay(13) As String 'declare gameplay as string
    ...
    Private Sub Q13_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'transfer Friend Varables from Question 12
        GPlayersRemaining = Q12.GPlayersRemaining
        GPlayerNumber = Q12.GPlayerNumber
        questionsRemaining = Q12.questionsRemaining
        AskFriendCount = Q12.AskFriendCount
        DoubleDipCount = Q12.DoubleDipCount
        AskAudienceCount = Q12.AskAudienceCount
        TopPrizeAmount.Text = Q12.TopPrizeAmount.Text
        Trust = Q12.Trust

        Winnings.question = 13
        ...
        If GPlayersRemaining = 6 Then
            'set QuestionValue to Question 13 Value
            QuestionValue.Text = "¥100,000"
        ...
        ElseIf GPlayersRemaining = 5 Then
            ...
            'set the value to Question 12
            QuestionValue.Text = "¥50,000"
    ...
    Sub QuestionLoading()
        ...
        Topic.Text = Q13GamePlay(0)
        Question1.Text = Q13GamePlay(1)
        Question2.Text = Q13GamePlay(2)
        Question3.Text = Q13GamePlay(3)
        ChoiceA.Text = Q13GamePlay(4)
        ChoiceB.Text = Q13GamePlay(5)
        ChoiceC.Text = Q13GamePlay(6)
        ChoiceD.Text = Q13GamePlay(7)
        PlayerScreen.Topic.Text = Q13GamePlay(0)
        PlayerScreen.question(0) = Q13GamePlay(1)
        PlayerScreen.question(1) = Q13GamePlay(2)
        PlayerScreen.question(2) = Q13GamePlay(3)
        PlayerScreen.question(3) = Q13GamePlay(4)
        PlayerScreen.question(4) = Q13GamePlay(5)
        PlayerScreen.question(5) = Q13GamePlay(6)
        PlayerScreen.question(6) = Q13GamePlay(7)

        'load the question on the PlayerScreen
        PlayerScreen.QuestionLoader()

        'set the answer
        answer = Q13GamePlay(8)

        'convert the choice text numbers
        CountA = CInt(Q13GamePlay(9))
        CountB = CInt(Q13GamePlay(10))
        CountC = CInt(Q13GamePlay(11))
        CountD = CInt(Q13GamePlay(12))
    ...
    Private Sub MasterButton_Click(sender As Object, e As EventArgs) Handles MasterButton.Click
        Select Case ButtonCount
            ...
            Case 1
                ...
                'start Question 13 Music
                My.Computer.Audio.Stop()
                My.Computer.Audio.Play(My.Resources.Question13, AudioPlayMode.Background)
            ...
            Case 2
                ...
                If Correct.Visible = True Or choice = answer Then
                    If GPlayersRemaining = 3 Then
                        'play Question 10 Correct Answer
                        My.Computer.Audio.Play(My.Resources.Question10Correct, AudioPlayMode.Background)
                    Else
                        'play Question 13 Correct Answer
                        My.Computer.Audio.Play(My.Resources.Question13Correct, AudioPlayMode.Background)
                    End If
                    ...
                    End If
                Else
                    'play Question 13 Incorrect
                    My.Computer.Audio.Play(My.Resources.Question13Wrong, AudioPlayMode.Background)
    ...
    Sub FinalAnswer()
        ...
        Else
            'play the question 13 Final Answer
            My.Computer.Audio.Play(My.Resources.Question13Final, AudioPlayMode.Background)
        End If
    ...
    Sub QuestionResult()
        ...
        If choice = answer Then
            ...
            Level4MoneyTree.Topic13.BackColor = Color.Green
            Level4MoneyTree.Topic13.ForeColor = Color.White
            PlayerScreen.Topic13.BackColor = Color.Green
            PlayerScreen.Topic13.ForeColor = Color.White
        Else
            'change the color of the topic to red
            Level4MoneyTree.Topic13.BackColor = Color.Red
            Level4MoneyTree.Topic13.ForeColor = Color.White
            PlayerScreen.Topic13.BackColor = Color.Red
            PlayerScreen.Topic13.ForeColor = Color.White
        End If
    End Sub
    ...
    Sub RestartQuestionClock()
        ...
        Select Case TimeSeconds
            Case 45
                My.Computer.Audio.Play(My.Resources.Question13, AudioPlayMode.Background)
            Case 30
                My.Computer.Audio.Play(My.Resources.Question13_30, AudioPlayMode.Background)
            Case 15
                My.Computer.Audio.Play(My.Resources.Question13_15, AudioPlayMode.Background)
        End Select
    End Sub
